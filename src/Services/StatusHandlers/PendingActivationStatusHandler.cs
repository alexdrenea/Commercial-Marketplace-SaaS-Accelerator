...
namespace Microsoft.Marketplace.SaaS.SDK.Services.StatusHandlers
{
    ...
    public class PendingActivationStatusHandler : AbstractSubscriptionStatusHandler
    {
        ...
        {
            this.logger?.LogInformation("PendingActivationStatusHandler: SubscriptionID={0}", subscriptionID);
            ...
            if (subscription.SubscriptionStatus == SubscriptionStatusEnumExtension.PendingActivation.ToString())
            {
                try
                {
                    this.logger?.LogInformation("Get Attributes List");
                ...
                catch (Exception ex)
                {
                    ...
                    this.subscriptionLogRepository.LogStatusDuringProvisioning(subscriptionID, errorDescription, SubscriptionStatusEnumExtension.ActivationFailed.ToString());
